...
if option == "Home":
    ...
    c2.metric("Accuracy", "80.20%", "+12.89% vs VADER")
...
# ════════════════════════════════════════
    ...
    c1, c2, c3, c4 = st.columns(4)
    c1.metric("Best Accuracy",      "80.20%")
    c2.metric("vs VADER baseline",  "+12.89%")
    c3.metric("Precision",          "0.80")
    ...
    This combination gives us +12.89% over VADER standalone.
    """)
